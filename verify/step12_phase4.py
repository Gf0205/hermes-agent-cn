...
串行执行：
- step10_phase4.py (Skill Distiller)
- step11_phase4.py (Cross-session Recall)
- step13_phase4.py (Draft Persistence)
- step14_phase4.py (Quality Score + Auto Adopt)
- step15_phase4.py (Adoption Audit + Rollback)
- step16_phase4.py (Targeted Rollback by Record ID)
"""
...
def print_summary(results: list[RunResult], total_elapsed_s: float) -> None:
    print("========== Phase 4 Regression Summary ==========")
...
def main() -> None:
    ...
    scripts = [
        current_dir / "step10_phase4.py",
        current_dir / "step11_phase4.py",
        current_dir / "step13_phase4.py",
        current_dir / "step14_phase4.py",
        current_dir / "step15_phase4.py",
        current_dir / "step16_phase4.py",
    ]
    ...
    if all(item.success for item in results):
        print("\n[DONE] Phase 4 regression passed")
        sys.exit(0)
