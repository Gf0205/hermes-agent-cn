...
串行执行：
- step23_phase6.py (Recall offline evaluation baseline)
- step25_phase6.py (Report diff / regression gate)
"""
...
def print_summary(results: list[RunResult], total_elapsed_s: float) -> None:
    print("========== Phase 6 Regression Summary ==========")
...
def main() -> None:
    ...
    scripts = [
        current_dir / "step23_phase6.py",
        current_dir / "step25_phase6.py",
    ]
    ...
    if all(item.success for item in results):
        print("\n[DONE] Phase 6 regression passed")
        sys.exit(0)
